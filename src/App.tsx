    ...
    async function completeZkLogin()
    {
        ...
        for (const account of accounts.current) {
            if (userAddr === account.userAddr) {
                console.warn(`[] already logged in with this ${setupData.provider} account`);
                return;
            }
        }
        ...
        .then(res => {
            console.debug("[] ZK proving service success");
            return res.json();
        })
        .catch((error: unknown) => {
            console.warn("[] ZK proving service error:", error);
            return null;
        })
        .finally(() => {
            setModalContent("");
